...
/**
 * Номер внутреннего паспорта, Россия.
 * @author zinal
 */
public class PassportDomestic implements ValueBasedClassifier {

    private final Pattern pattern = Pattern.compile("^\\d{2}\\s*\\d{2}\\s*\\d{6}$");
