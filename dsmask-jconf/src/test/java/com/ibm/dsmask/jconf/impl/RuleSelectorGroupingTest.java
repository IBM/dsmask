...
public class RuleSelectorGroupingTest {
    ...
    /**
     * Basic test of a rule selector, with field grouping.
     */
    @Test
    public void testSelectGrouping() {
        // input table
        TableInfo table = RuleSelectorData.tableGrouping();
...
//        System.out.println("OUTPUT: " + result.getOperations());
        ...
        MaskingProfile expected = RuleSelectorData.
                profileGrouping(table, maskingRuleRegistry);
